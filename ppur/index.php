...
<html lang="pt-br">
  ...
  <body>
    ...
    <div id="main">
      <div class="banner">
    <div id="slider">
        <img class="selected" src="img/banner1.jpg" alt="Image1">
    </div>
    <script src="js/banner.js"></script>
  </div>
      </div>
    <div class="noticias">
      <br><h1 style="font-weight:bold;text-align: center;">Últimas Notícias</h1><br>
      <div class="container">
<?php 
      include 'php/conn.php';
        $sql="SELECT * FROM noticia ORDER BY not_id desc LIMIT 3";
      ...
      while($mostrar=mysqli_fetch_assoc($consulta))
        {
          ...
          echo "<p><center>".$mostrar['not_data']." | ".utf8_encode($mostrar['not_hora'])."</center></p><br>";
...
?>
    ...
    <div class="rodape1">
        ...
        <div style="margin:20px; height: 250px;">
          <p style="color: #ffd91e"><a href="informacoes.html">Informações</a></p>
              <li>
        ...
        <div style="margin:30px; height: 250px;">
